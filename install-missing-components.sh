...
echo "🚀 Installing missing components manually..."

# First, install all required dependencies
echo "📦 Installing Radix UI dependencies..."
npm install @radix-ui/react-avatar @radix-ui/react-select @radix-ui/react-toast @radix-ui/react-alert-dialog --save --legacy-peer-deps

# Create all missing component files
echo "📝 Creating card.tsx..."
...
echo "📝 Creating alert-dialog.tsx..."
cat > components/ui/alert-dialog.tsx << 'ALERT'
"use client"
...
cat > components/ui/select.tsx << 'SELECT'
"use client"
...
echo "📝 Creating table.tsx..."
cat > components/ui/table.tsx << 'TABLE'
import * as React from "react"
import { cn } from "@/lib/utils"
...
echo "📝 Creating toast.tsx..."
cat > components/ui/toast.tsx << 'TOAST'
"use client"
